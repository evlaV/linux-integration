                      ...
                      unsigned int nr_to_write)
{
	...
	ktime_t start;
	ktime_t stop;
	char pm_wakeup_pending_wait_target[MAX_PM_WAKEUP_PENDING_WAIT_TARGET_LEN];
